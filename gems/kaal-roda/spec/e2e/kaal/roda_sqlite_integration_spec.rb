...
RSpec.describe Kaal::Roda, integration: :sqlite do
  include RodaIntegrationHelpers

  it 'integrates a Roda app through the sqlite backend' do
    run_dummy_app(backend: 'sqlite') do |app_root, _env, lines|
      database_path = KaalRodaDummyAppSupport.database_path(app_root)
