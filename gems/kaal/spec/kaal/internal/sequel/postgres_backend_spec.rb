...
RSpec.describe Kaal::Internal::Sequel::PostgresBackend do
  let(:connection) do
    Class.new do
  ...
  it 'covers unsuccessful lock attempts and signed-id conversion' do
    ...
    allow(Digest::MD5).to receive(:digest).and_return([Kaal::Internal::Sequel::PostgresBackend::SIGNED_64_MAX + 1].pack('Q>'))
