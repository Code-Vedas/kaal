...
module KaalActiveRecordSupport
  ...
  def create_schema!(locks:)
    connection = Kaal::Internal::ActiveRecord::BaseRecord.connection
  ...
  def connect!(database_url)
    Kaal::ActiveRecord.require_activerecord!
    Kaal::Internal::ActiveRecord::ConnectionSupport.configure!(database_url.gsub('\\!', '!'))
  end

  def disconnect_target_connections!
    base_record = Kaal::Internal::ActiveRecord::BaseRecord
    return unless base_record.connected?

    base_record.connection_pool.disconnect!
    base_record.remove_connection
