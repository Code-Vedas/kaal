...
module Kaal
  # Resolves environment and path information for framework integrations.
  class RuntimeContext
    DEFAULT_ENVIRONMENT_NAME = 'development'
    ENVIRONMENT_KEYS = %w[KAAL_ENV RAILS_ENV RACK_ENV APP_ENV].freeze
    ...
    def self.from_rails(rails_context)
      new(root_path: rails_context.root, environment_name: rails_context.env)
    end
